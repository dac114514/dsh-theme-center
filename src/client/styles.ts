/**
 * Stylesheet injected by the plugin (one style tag, like every shipped
 * client bundle). Covers the gallery UI and the wallpaper surface.
 */
export const PLUGIN_CSS_TAG = "dsh-theme-center/styles.css";
